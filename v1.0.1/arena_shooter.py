...
pygame.mixer.music.load("Arena Sounds//Max Brhon - Redemption [NCS Release].mp3")
# gun_shot_sound = pygame.mixer.Sound('arena sounds//Gunshot-Sound-Effect-Single-Shot.mp3')
# kill_sound = pygame.mixer.Sound('arena sounds//399466__skamos66__a4.wav')
# death_sound = pygame.mixer.Sound('arena sounds//291556__modularsamples__fender-chroma-polaris-velkikblip-e3-52e2-c5tv.wav')
gun_shot_sound = pygame.mixer.Sound('arena sounds//gun_shot_sound.wav')
kill_sound = pygame.mixer.Sound('arena sounds//kill_sound.wav')
death_sound = pygame.mixer.Sound('arena sounds//death_sound.wav')
start_sound = pygame.mixer.Sound('arena sounds//357903__mtg__cello-c2.wav')
flamethrower_sound = pygame.mixer.Sound('arena sounds//flame_thrower_sound2.mp3')
sword_swish_sound = pygame.mixer.Sound('arena sounds//sword_swish_sound.mp3')
explosion_sound = pygame.mixer.Sound('arena sounds//explosion_sound.mp3')
# city_ambience = pygame.mixer.Sound('arena sounds//Street-Ambiance-Traffic-Trams.wav')
# mountain_ambience = pygame.mixer.Sound('arena sounds//mountainambience.mp3')
# sky_ambience = pygame.mixer.Sound('arena sounds//Strong-Wind-Blowing.wav')

# background_map_sounds = [mountain_ambience, mountain_ambience, city_ambience, sky_ambience]
...
player_image = pygame.image.load('arena images//player_image_2.png')
reload_box_image = pygame.image.load('arena images//reload_box.png')
# platform_image_1 = pygame.image.load('arena images//platform_1_1.png')
# platform_image_2 = pygame.image.load('arena images//platform_2.png')
# center_base_image = pygame.image.load('arena images//center_base.png')
# ground_piece_1_image = pygame.image.load('arena images//ground_piece_1_1.png')
# ground_piece_2_image = pygame.transform.flip(ground_piece_1_image, True, False)
# ground_piece_3_image = pygame.image.load('arena images//ground_piece_3.png')
# floating_platform_1_image = pygame.transform.scale(pygame.image.load('arena images//floating_platform_1.png'), (220, 110))
# floating_platform_2_image = pygame.image.load('arena images//floating_platform_2.png')
# floating_platform_3_image = pygame.image.load('arena images//floating_platform_3.png')
# floating_platform_4_image = pygame.image.load('arena images//floating_platform_4.png')
# city_ground_main_image = pygame.image.load('arena images//city_ground_main.png')
# city_ground_piece_1_image = pygame.image.load('arena images//city_ground_piece_1j.png')
# city_ground_piece_2_image = pygame.transform.flip(city_ground_piece_1_image, True, False)
# city_structure_piece_1_image = pygame.image.load('arena images//city_structure_piece_1b.png')
# city_structure_piece_2_image = pygame.transform.flip(city_structure_piece_1_image, True, False)
# city_structure_piece_3_image = pygame.image.load('arena images//city_structure_piece_2.png')
# city_structure_piece_4_image = pygame.transform.flip(city_structure_piece_3_image, False, True)
# city_cieling_piece_1_image = pygame.image.load('arena images//city_cieling_piece_1.png')
# city_cieling_piece_2_image = pygame.transform.flip(city_cieling_piece_1_image, True, False)
# city_cieling_piece_3_image = pygame.image.load('arena images//city_cieling_piece_2.png')
# city_platform_image = pygame.image.load('arena images//city_platform.png')

basic_bullet_image = pygame.image.load('arena images//basic_bullet_sprite.png')
sniper_bullet_image = pygame.image.load('arena images//sniper_bullet_sprite.png')
rocket_bullet_image = pygame.image.load('arena images//altsniper_bullet_sprite.png')
sword_attack_image = pygame.image.load('arena images//sword_slash_effect.png')
rocket_image = pygame.image.load('arena images//rocket.png')
explosion_image = pygame.image.load('arena images//explosion_image.png')
energy_ball_image = pygame.image.load("arena images//energy_ball_sprite.png")
fireball_image = pygame.image.load('arena images//fire5.png')
end_fireball_image = pygame.image.load('arena images//fire6.png')
assault_rifle_image = pygame.image.load("arena images//pixil-frame-0 (42).png")
assault_rifle_firing_image = pygame.image.load("arena images//Assault_Rifle_firing.png")
# best_gun_image = pygame.image.load("arena images//pixil-frame-0 (47).png")
assault_rifle_images = [assault_rifle_image, assault_rifle_firing_image]
flamethrower_image = pygame.image.load("arena images//flamethrower2.png")
sniper_rifle_image = pygame.image.load("arena images//sniper_rifle.png")
sniper_rifle_firing_image = pygame.image.load("arena images//sniper_rifle_firing.png")
sniper_rifle_images = [sniper_rifle_image, sniper_rifle_firing_image]
smg_image = pygame.image.load("arena images//smg.png")
smg_firing_image = pygame.image.load("arena images//smg_firing.png")
smg_images = [smg_image, smg_firing_image]
semi_auto_image = pygame.image.load("arena images//semi_auto.png")
semi_auto_firing_image = pygame.image.load("arena images//semi_auto_firing.png")
semi_auto_images = [semi_auto_image, semi_auto_firing_image]
lmg_image = pygame.image.load("arena images//lmg.png")
lmg_firing_image = pygame.image.load("arena images//lmg_firing.png")
lmg_images = [lmg_image, lmg_firing_image]
rpg_image = pygame.image.load("arena images//rpg.png")
rpg_firing_image = pygame.image.load("arena images//rpg_firing.png")
rpg_empty_image = pygame.image.load("arena images//empty_rpg.png")
rpg_images = [rpg_image, rpg_firing_image, rpg_empty_image]
sword_image = pygame.image.load("arena images//sword2.png")
sword_attack_image1 = pygame.image.load("arena images//sword2_attack_1.png")
sword_attack_image2 = pygame.image.load("arena images//sword2_attack_2.png")
sword_attack_image3 = pygame.image.load("arena images//sword2_attack_3.png")
sword_attack_image4 = pygame.image.load("arena images//sword2_attack_4.png")
sword_attack_image5 = pygame.image.load("arena images//sword2_attack_5.png")
sword_attack_image6 = pygame.image.load("arena images//sword2_attack_6.png")
...
shotgun_image = pygame.image.load("arena images//shotgun.png")
shotgun_firing_image = pygame.image.load("arena images//shotgun_firing.png")
...
# sky_background = pygame.image.load('arena images//cool_sky_background.jpg')
# cool_landscape_1 = pygame.image.load('arena images//wallpapersden.com_artistic-orange-landscape_1920x1080.jpg')
# pyramid_background_image = pygame.image.load('arena images//background_image_option.jpg')
# cave_background_image = pygame.image.load('arena images//test_background.jpg')
map_1_background_image = pygame.image.load('arena images//map_1_background.png')
map_2_background_image = pygame.image.load('arena images//map_2_background.png')
map_3_background_image = pygame.image.load('arena images//map_3_background.png')
map_4_background_image = pygame.image.load('arena images//map_4_background.png')

background_images = [map_1_background_image, map_2_background_image, map_3_background_image, map_4_background_image]
# pyramid_piece_bottom_image_1 = pygame.image.load('arena images//pyramid_bottom_piece_1_f.png')
# pyramid_piece_bottom_image_2 = pygame.image.load('arena images//pyramid_bottom_piece_2_f.png')
# pyramid_piece_mid_image = pygame.image.load('arena images//pyramid_piece_mid.png')
# pyramid_piece_top_image = pygame.image.load('arena images//pyramid_top_piece_f.png')
# pyramid_piece_1_image = pygame.image.load('arena images//pyramid_piece_111.png')
# pyramid_piece_2_image = pygame.image.load('arena images//pyramid_piece_222.png')
# pyramid_platform_image = pygame.image.load('arena images//pyramid_platform_4.png')
# pyramid_upper_platform_image = pygame.image.load('arena images//pyramid_upper_platform_f.png')
# pyramid_ground_image = pygame.image.load('arena images//pyramid_ground.png')
# fix_image = pygame.image.load('arena images//fix_piece.png')
# difficulty_menu_button_main_image = pygame.image.load('arena images//difficulty_button_main.png')
# difficulty_menu_button_side_image = pygame.image.load('arena images//difficulty_button_side.png')
# loadout_menu_button_main_image = pygame.image.load('arena images//loadout_button_main.png')
# loadout_menu_button_side_image = pygame.image.load('arena images//loadout_button_side.png')
# map_menu_button_main_image = pygame.image.load('arena images//map_button_main.png')
# map_menu_button_side_image = pygame.image.load('arena images//map_button_side.png')
# play_menu_button_main_image = pygame.image.load('arena images//play_button_main.png')
# play_menu_button_side_image = pygame.image.load('arena images//play_button_side.png')

main_menu_image = pygame.image.load('arena images//main_menu_image.png')
map_menu_image = pygame.image.load('arena images//map_menu_image.png')
gun_menu_image = pygame.image.load('arena images//gun_menu_image.png')
    ...
    while in_main_menu:
        ...
        while playing:
            ...
            if player2_shot_timer > gun_fire_rate_list[gun_choice2] and player2_ammo > 0 and not player2_reload and \
                    timer > 60 and distance_to_player < gun_range_list[gun_choice2]*40:
                P2_gun_state = 1
                ...
                bullet_hitbox = Hitbox(10, 10, player2_hitbox.rect.centerx, player2_hitbox.rect.centery, red, 3,
                                       angle2)
                if sound_timer2 > 10 and overall_sound_timer > 3:
                    sound_timer2 = 0
                    overall_sound_timer = 0
                    if not gun_choice2 == 2 and not gun_choice2 == 5 and not gun_choice2 == 7 and \
                            not gun_choice2 == 9:
                        gun_shot_sound.play(0)
                    elif gun_choice2 == 2 or gun_choice2 == 5 or gun_choice2 == 9:
                        flamethrower_sound.play(0)
                    elif gun_choice2 == 7:
                        sword_swish_sound.play(0)
            ...
            if player1_shot_timer > gun_fire_rate_list[gun_choice1] and player1_ammo > 0 and not player1_reload \
                ...
                if shot_fired:
                    ...
                    bullet_hitbox = Hitbox(10, 10, player1_hitbox.rect.centerx, player1_hitbox.rect.centery, red, 2,
                                           angle1)
                    if sound_timer1 > 10 and overall_sound_timer > 3:
                        sound_timer1 = 0
                        overall_sound_timer = 0
                        if not gun_choice1 == 2 and not gun_choice1 == 5 and not gun_choice1 == 7 and \
                                not gun_choice1 == 9:
                            gun_shot_sound.play(0)
                        elif gun_choice1 == 2 or 5 or 9:
                            flamethrower_sound.play(0)
                        elif gun_choice1 == 7:
                            sword_swish_sound.play(0)
                    shot_fired = False
